...
class MenuService
{
    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            'ext_phone_call_agent_outbound' => [
                'parent_key'       => 'ext_phone_call_agent',
                'key'              => 'ext_phone_call_agent_outbound',
                'route'            => 'dashboard.phone-call-agent.outbound.index',
                ...
                'extension'        => true,
                'active_condition' => [
                    'dashboard.phone-call-agent.outbound.*',
                ],
                'show_condition' => MarketplaceHelper::isRegistered('phone-call-agent'),
            ],
            ...
            'salla' => [
                'parent_key'       => null,
                'key'              => 'salla',
                'route'            => 'dashboard.user.salla.index',
                'route_slug'       => null,
                'label'            => 'Salla',
                'data-name'        => null,
