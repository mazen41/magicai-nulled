...
/**
 * Seedance 2.5 - Text-to-Video, Image-to-Video, and Reference-to-Video generation
 *
 * Native 30-second video with synchronized audio.
 *
 * @see https://fal.ai/models/bytedance/seedance-2.5/text-to-video
 * @see https://fal.ai/models/bytedance/seedance-2.5/image-to-video
 * @see https://fal.ai/models/bytedance/seedance-2.5/reference-to-video
 */
class Seedance25 implements TextToVideoModelInterface
{
    ...
    {
        $res = $this->client->request('get', "bytedance/seedance-2.5/requests/$requestId/status");
    ...
    {
        $res = $this->client->request('get', "bytedance/seedance-2.5/requests/$requestId");
