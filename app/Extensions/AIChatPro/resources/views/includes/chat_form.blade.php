        ...
        <div
            ...
            <div class="relative flex grow items-center max-md:px-2">
                ...
                <div
                    ...
                    >
                        <x-slot:trigger
                            class="size-[34px] shrink-0 origin-center border border-foreground/5 p-0 max-md:bg-surface-background max-md:shadow-sm max-md:shadow-black/5 lg:size-11"
                        >
                        ...
                        <x-slot:dropdown>
                            ...
                            <div
                                    ...
                                    @auth
                                        ...
                                        >
                                            <x-forms.input
                                                ...
                                                @change.prevent="toggleToolSelection('realtime'); handleRealtimeChange($event);"
                                                x-init="$watch('selectedTools', value => { if (!value.includes('realtime')) $el.checked = false })"
                                            >
                                                <x-slot:label-extra>
                                ...
                                @include('ai-chat-pro::connectors.chat-connectors-button')
                    ...
                    >
                        ...
                        @auth
                            {{-- Record Audio --}}
                            <div class="pointer-events-auto group-[&.prompt-filled]/chats-wrap:hidden group-[&.submitting]/chats-wrap:hidden">
                                <x-button
                                ...
                                <x-button
                                    class="lqd-chat-record-stop-trigger hidden size-[34px] shrink-0 cursor-pointer items-center justify-center gap-2 border border-foreground/5 text-heading-foreground transition-all hover:border-primary hover:bg-primary hover:text-primary-foreground group-[&.submitting]/chats-wrap:hidden lg:size-11 [&.active]:flex"
                        ...
                        {{-- Send button --}}
                        <div class="pointer-events-auto hidden group-[&.prompt-filled]/chats-wrap:block group-[&.submitting]/chats-wrap:block">
                            <x-button
