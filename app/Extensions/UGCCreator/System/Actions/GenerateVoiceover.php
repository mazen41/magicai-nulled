 ...
 *
 * Writes the audio to the public disk and returns the stored relative path
 * (e.g. "ugc-creator/audio/<uuid>.mp3"). Mirrors UGC Factory's voiceover flow.
 */
class GenerateVoiceover
{
    ...
    public function __invoke(string $provider, string $voiceId, string $script, ?string $language = null): array
    {
        ...
        $path = 'ugc-creator/audio/' . Str::uuid()->toString() . '.mp3';
