                    ...
                    <div class="text-center">
                        ...
                        <p class="mb-4 flex items-center justify-center gap-1.5 text-[12px] font-medium">
                            <span @class([
                                ...
                                'bg-green-500' => $app_is_demo ? true: $agent->is_active,
                                'bg-foreground/50' => $app_is_demo ? false : !$agent->is_active,
                            ])></span>
                            {{ $app_is_demo ? __('Active') :  ($agent->is_active ? __('Active') : __('Inactive')) }}
                        </p>
