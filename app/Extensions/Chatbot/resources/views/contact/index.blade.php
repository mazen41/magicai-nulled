...
@section('titlebar_actions')
    @if (\App\Helpers\Classes\MarketplaceHelper::isRegistered('crm') && setting('crm_contact_sync_enabled', '0') && setting('crm_sync_chatbot', '0'))
        @include('crm::partials.sync-button', ['source' => 'chatbot'])
    @endif
@endsection
